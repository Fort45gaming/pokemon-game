...
root=Tk() 
root.title("bob has returned")
root.geometry("500x500")
root.configure(background="green")

c_lab = Label(root,text="enter a colour:")
c_lab.place(relx=0.6,rely=0.9,anchor=CENTER)

imput_box = Entry(root)
imput_box.insert(0,"red")
imput_box.place(relx=0.8,rely=0.9,anchor=CENTER)

canvas=Canvas(root,width=590,height=510,bg="white",highlightbackground="lightblue")
canvas.pack()
